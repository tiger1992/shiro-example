...
public class PermissionTest extends BaseTest {
    ...
    public void testIsPermitted() {
    	...
    	System.out.println("判断拥有权限：user:update and user:delete = " + subject.isPermittedAll("user:update", "user:delete"));
    ...
    public void testWildcardPermission1() {
    	Subject	subject = login("classpath:shiro-permission.ini", "li", "123");
